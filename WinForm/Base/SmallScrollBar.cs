...
namespace WinForm.Base
{
    ...
    public class SmallScrollBar : Control
    {
        #region Event Region
        ...
        private ScrollOrientation _scrollDirection;
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (_thumbArea.Contains(e.Location) && e.Button == MouseButtons.Left)
            {
                ...
                if (_scrollDirection == ScrollOrientation.VerticalScroll)
            ...
            if (_trackArea.Contains(e.Location) && e.Button == MouseButtons.Left)
            {
                ...
                else if (_scrollDirection == ScrollOrientation.HorizontalScroll)
                {
        ...
        {
            var isVert = _scrollDirection == ScrollOrientation.VerticalScroll;
        ...
        private void UpdateThumb(bool forceRefresh = false)
        {
            ...
            if (_scrollDirection == ScrollOrientation.VerticalScroll)
            {
                ...
                _thumbArea = new Rectangle(_trackArea.Left + 2, _trackArea.Top + thumbPosition, Consts.ScrollBarSize / 2, thumbSize);
            }
            else if (_scrollDirection == ScrollOrientation.HorizontalScroll)
            {
                ...
                _thumbArea = new Rectangle(_trackArea.Left + thumbPosition, _trackArea.Top + 2, thumbSize, Consts.ScrollBarSize / 2);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Scrollbar bg
            using (var b = new SolidBrush(VColors.GreyBackground))
            {
            ...
            // Up arrow
            var upIcon = _upArrowHot ? Resources.scrollbar_arrow_small_hot : Resources.scrollbar_arrow_small_standard;

            if (_upArrowClicked)
                upIcon = Resources.scrollbar_arrow_small_clicked;

            if (!Enabled)
                upIcon = Resources.scrollbar_arrow_disabled;
            ...
            // Down arrow
            var downIcon = _downArrowHot ? Resources.scrollbar_arrow_small_hot : Resources.scrollbar_arrow_small_standard;

            if (_downArrowClicked)
                downIcon = Resources.scrollbar_arrow_small_clicked;

            if (!Enabled)
                downIcon = Resources.scrollbar_arrow_disabled;

            if (_scrollDirection == ScrollOrientation.HorizontalScroll)
            ...
            if (Enabled)
            {
                var scrollColor = _thumbHot ? VColors.BlueHighlight : VColors.UnActiveBar;

                if (_isScrolling)
                    scrollColor = VColors.ActiveControlBackground;
